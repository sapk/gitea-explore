...
/*RepoDeleteFileOK handles this case with default header values.
...
func (o *RepoDeleteFileOK) Error() string {
	return fmt.Sprintf("[DELETE /repos/{owner}/{repo}/contents/{filepath}][%d] repoDeleteFileOK  %+v", 200, o.Payload)
}
