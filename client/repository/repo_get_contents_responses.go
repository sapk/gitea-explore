...
/*RepoGetContentsOK handles this case with default header values.
...
func (o *RepoGetContentsOK) Error() string {
	return fmt.Sprintf("[GET /repos/{owner}/{repo}/contents/{filepath}][%d] repoGetContentsOK  %+v", 200, o.Payload)
}
