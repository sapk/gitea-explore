...
/*UserCurrentListFollowersOK handles this case with default header values.
...
func (o *UserCurrentListFollowersOK) Error() string {
	return fmt.Sprintf("[GET /user/followers][%d] userCurrentListFollowersOK  %+v", 200, o.Payload)
}
